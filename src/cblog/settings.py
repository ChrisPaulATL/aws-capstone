...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name="/chris/capstone/username", WithDecryption=True)
    password_param = ssm.get_parameter(Name="/chris/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'chris-rds-latest.ct6euumky2fo.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'chris-aws-capstone-blog-s3' # please enter your s3 bucket name
